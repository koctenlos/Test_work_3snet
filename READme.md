...
проверяется, что в поле с кодом присутствует iframe

проверяется наличие обязательных атрибутов iframe

проверяется, что поле с кодом недоступно для редактирования
----------------------------------
